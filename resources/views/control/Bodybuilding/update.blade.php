...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="table-responsive">
      ...
      <form method="post" action="{{ Route('Bodybuilding.update',$data->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-sm-6">
          <div class="form-group">
            <label for="name_machine">إسم الألة</label>
            <input type="text" class="form-control" id="name_machine" name="name_machine" value="{{ $data->name_machine }}"
              aria-describedby="emailHelp" placeholder="إسم الألة">
          </div>
